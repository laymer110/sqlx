...
var origMapper = reflect.ValueOf(snakeCasedName)
...
func mapper() *reflectx.Mapper {
	...
	if mpr == nil {
		mpr = reflectx.NewMapperFunc("db", snakeCasedName)
	} else if origMapper != reflect.ValueOf(snakeCasedName) {
		// if NameMapper has changed, create a new mapper
		mpr = reflectx.NewMapperFunc("db", snakeCasedName)
		origMapper = reflect.ValueOf(snakeCasedName)
	}
	return mpr
}
