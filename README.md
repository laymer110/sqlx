...
In addition to the [godoc API documentation](http://godoc.org/github.com/laymer110/sqlx),
...
## install
    ...
    go get github.com/laymer110/sqlx
...
[sqlx_test.go](https://github.com/laymer110/sqlx/blob/master/sqlx_test.go) for more
usage.
